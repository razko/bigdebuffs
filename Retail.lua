...
addon.Spells = {
    ...
    [108194] = { type = CROWD_CONTROL }, -- Asphyxiate (Frost, Unholy)
    ...
    [33891] = { type = BUFF_OFFENSIVE }, -- Incarnation: Tree of Life (for the menu entry - the tooltip for "Incarnation" doesn't say its for ToL)
        [117679] = { type = BUFF_OFFENSIVE, parent = 33891 }, -- Incarnation (buff that grants access to Tree of Life form)
    ...
    [333100] = { type = BUFF_OFFENSIVE }, -- Firestorm (Fire Legendary "Combustion" proc)
    ...
    [322459] = { type = DEBUFF_OFFENSIVE }, -- Thoughtstolen (Shaman)
        ...
        [323716] = { type = DEBUFF_OFFENSIVE, parent = 322459 }, -- Thoughtstolen (NPCs, simply silences them)
    ...
    [198817] = { type = BUFF_OFFENSIVE }, -- Sharpen Blade (Arms PvP Talent)
